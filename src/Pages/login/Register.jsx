...
//     register("file").onChange(e);  // ✅ tell react-hook-form
//   }}
//   className="hidden"
// />
...
const DEFAULT_PHOTO_URL =
  "https://i.ibb.co/2FsfXqM/user-placeholder.png";
...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await updateUserProfile(data.name, DEFAULT_PHOTO_URL);
        ...
        <div className="hidden lg:block">
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Create your account and manage healthcare securely.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center py-3 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white"
              >
                {loading ? (
                  <>
            ...
            <button
              onClick={handleGoogleLogin}
              disabled={loading}
              className="mt-6 w-full border rounded-lg py-3 flex justify-center items-center"
            >
